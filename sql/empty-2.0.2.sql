...
CREATE TABLE `glpi_plugin_archibp_tasks` (
  ...
  `plugin_archibp_tasks_id` INT(11) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `glpi_plugin_archibp_tasks_items` (
	...
	`plugin_archibp_tasks_id` INT(11) UNSIGNED NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_archibp_tasks (id)',
